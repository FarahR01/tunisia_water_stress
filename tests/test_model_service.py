...
class TestModelServiceExtrapolation:
    ...
    def service_with_data(self):
        ...
        data = pd.DataFrame({
            'Water productivity, total (constant 2015 US$ GDP per cubic meter of total freshwater withdrawal)': [5.0, 6.0, 7.0, 8.0, 9.0],
            'Annual freshwater withdrawals, agriculture (% of total freshwater withdrawal)': [80.0, 78.0, 76.0, 74.0, 72.0],
            'Annual freshwater withdrawals, industry (% of total freshwater withdrawal)': [3.0, 4.0, 5.0, 6.0, 7.0],
            'Renewable internal freshwater resources, total (billion cubic meters)': [4.5, 4.4, 4.3, 4.2, 4.1],
