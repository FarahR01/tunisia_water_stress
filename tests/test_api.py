...
class TestHealthEndpoint:
    ...
    def test_health_check_returns_model_count(
        self, test_client: TestClient, api_prefix: str, mock_model_service: Mock
    ):
...
class TestPredictionEndpoint:
    ...
    def test_predict_with_year_only(self, test_client: TestClient, api_prefix: str):
        ...
        response = test_client.post(f"{api_prefix}/predictions", json={"year": 2025})
    ...
    def test_predict_invalid_year_low(self, test_client: TestClient, api_prefix: str):
        ...
        response = test_client.post(f"{api_prefix}/predictions", json={"year": 1900})
    ...
    def test_predict_invalid_year_high(self, test_client: TestClient, api_prefix: str):
        ...
        response = test_client.post(f"{api_prefix}/predictions", json={"year": 2200})

        assert response.status_code == 422

    def test_predict_invalid_withdrawal_percentages(self, test_client: TestClient, api_prefix: str):
    ...
    def test_predict_extra_fields_rejected(self, test_client: TestClient, api_prefix: str):
        ...
        response = test_client.post(
            f"{api_prefix}/predictions", json={"year": 2025, "extra_field": "should_fail"}
        )
...
class TestBatchPredictionEndpoint:
    ...
    def test_batch_predict_success(self, test_client: TestClient, api_prefix: str):
        ...
        response = test_client.post(
            ...
            json={"predictions": [{"year": 2025}, {"year": 2026}, {"year": 2027}]},
        )
    ...
    def test_batch_predict_empty_list(self, test_client: TestClient, api_prefix: str):
        ...
        response = test_client.post(f"{api_prefix}/predictions/batch", json={"predictions": []})
    ...
    def test_batch_predict_too_many(self, test_client: TestClient, api_prefix: str):
        ...
        response = test_client.post(
            f"{api_prefix}/predictions/batch", json={"predictions": predictions}
        )
...
class TestScenarioEndpoint:
    ...
    def test_scenario_default(self, test_client: TestClient, api_prefix: str):
        ...
        response = test_client.post(f"{api_prefix}/scenarios", json={})
    ...
    def test_scenario_custom_year(self, test_client: TestClient, api_prefix: str):
        ...
        response = test_client.post(f"{api_prefix}/scenarios", json={"target_year": 2050})
    ...
    def test_scenario_all_trend_methods(self, test_client: TestClient, api_prefix: str):
        ...
        for method in ["linear", "exponential", "last_value", "average"]:
            response = test_client.post(f"{api_prefix}/scenarios", json={"trend_method": method})
    ...
    def test_scenario_invalid_trend_method(self, test_client: TestClient, api_prefix: str):
        ...
        response = test_client.post(
            f"{api_prefix}/scenarios", json={"trend_method": "invalid_method"}
        )
...
class TestErrorHandling:
    ...
    def test_model_not_found_error(
        ...
        mock_model_service.predict.side_effect = ModelNotFoundError(
            "InvalidModel", ["Lasso", "Ridge"]
        )

        response = test_client.post(
            f"{api_prefix}/predictions", json={"year": 2025, "model_name": "InvalidModel"}
        )

        # Either 404 (if mock applies) or 200 (if real service handles it)
        assert response.status_code in [200, 404]

    def test_invalid_model_name_in_request(self, test_client: TestClient, api_prefix: str):
        """Test request with invalid model name format."""
        # Test with very long model name (exceeds max_length=50)
        response = test_client.post(
            f"{api_prefix}/predictions", json={"year": 2025, "model_name": "x" * 100}
        )

        assert response.status_code == 422

    def test_generic_error_response_format(self, test_client: TestClient, api_prefix: str):
        """Test that error responses have correct format."""
        # Request with invalid data to trigger validation error
        response = test_client.post(f"{api_prefix}/predictions", json={"year": "not_a_number"})
